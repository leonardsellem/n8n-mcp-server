/**
 * Base Variables Tool Handler
 *
 * This module provides a base handler for variables-related tools.
 */
...
/**
 * Base class for variables tool handlers
 */
export abstract class BaseVariablesToolHandler {
  ...
  protected async handleExecution(
    ...
    try {
      ...
      return this.formatError(`Error executing variables tool: ${errorMessage}`);
    }
  }
}

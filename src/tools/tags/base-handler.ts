/**
 * Base Tags Tool Handler
 *
 * This module provides a base handler for tags-related tools.
 */
...
/**
 * Base class for tags tool handlers
 */
export abstract class BaseTagsToolHandler {
  ...
  protected async handleExecution(
    ...
    try {
      ...
      return this.formatError(`Error executing tags tool: ${errorMessage}`);
    }
  }
}

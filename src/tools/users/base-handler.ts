/**
 * Base Users Tool Handler
 *
 * This module provides a base handler for users-related tools.
 */
...
/**
 * Base class for users tool handlers
 */
export abstract class BaseUsersToolHandler {
  ...
  protected async handleExecution(
    ...
    try {
      ...
      return this.formatError(`Error executing users tool: ${errorMessage}`);
    }
  }
}

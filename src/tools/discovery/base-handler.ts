/**
 * Base Discovery Tool Handler
 *
 * This module provides a base handler for discovery-related tools.
 */
...
/**
 * Shared API client instance for all discovery handlers
 */
...
/**
 * Base class for discovery tool handlers
 */
export abstract class BaseDiscoveryToolHandler {
  ...
  protected async handleExecution(
    ...
    try {
      ...
      return this.formatError(`Error executing discovery tool: ${errorMessage}`);
    }
  }

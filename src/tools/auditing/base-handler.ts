/**
 * Base Auditing Tool Handler
 *
 * This module provides a base handler for auditing-related tools.
 */
...
/**
 * Base class for auditing tool handlers
 */
export abstract class BaseAuditingToolHandler {
  ...
  protected async handleExecution(
    ...
    try {
      ...
      return this.formatError(`Error executing auditing tool: ${errorMessage}`);
    }
  }
